...
import { User, Mail, Shield, LogOut, Trash2, Camera } from 'lucide-react';
...
const AccountTab = () => {
    ...
    const initials = user?.name?.split(' ').map(n => n[0]).join('').toUpperCase().slice(0, 2) || 'WV';
            ...
            <div className="bg-[#1A231F] border border-[#2A3430] rounded-2xl p-6">
                <div className="flex items-center gap-6 mb-8 text-left">
                    ...
                    <div>
                        ...
                        <span className="mt-1 inline-block text-xs px-2 py-0.5 bg-emerald-900/40 text-emerald-400 rounded-full border border-emerald-800">
